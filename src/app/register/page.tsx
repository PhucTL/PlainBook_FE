  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        {/* Header */}
        <AnimatedSection animation="fade-up" duration={500} delay={0}>
        ...
        {/* Card */}
        <AnimatedSection animation="scale" duration={600} delay={100}>
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            {/* Sign In Link */}
            <AnimatedSection animation="fade-up" duration={500} delay={250}>
